...
def tell_absent():
    cursor = mysql.get_db().cursor()
    cursor.execute('select emp_name from IoT_Project.Employee_Info as a left join (select * \
    from IoT_Project.Tag where tag_time between "2019-08-10 00:00:00" and "2019-08-10 23:00:00") as b \
    on a.emp_id = b.emp_id where b.tag_type is null')
